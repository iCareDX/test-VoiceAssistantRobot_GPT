...
import re
from test_bot_listener import bot_listen_hear
from test_bot_gpt_analyzer import chat_with_agent

# from bot_motor_controller import neopixels_off, pan_tilt_slow, neopixels_face
from test_bot_voice_synthesizer import speak, speak_popen
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            # speak_popen(str(cleaned_robot_reply), 1)

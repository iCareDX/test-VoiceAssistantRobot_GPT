...
import openai, os, json, datetime # dotenv,
...
# 顔認証ツール
from ex_bot_face_track_recognizer import face_recognize
# 物体認識ツール
from ex_bot_object_detecter import object_detection
...
llm = ChatOpenAI(openai_api_key="EMPTY", openai_api_base="http://192.168.11.101:8080/v1", model_name="gpt-3.5-turbo", temperature=0) #"gpt-3.5-turbo-16k-0613"
...
def chat_with_agent(text):
    ...
    try:
        ...
        memory.save_context(inputs, {"outputs": ai_message})
